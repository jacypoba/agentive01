...
export async function GET(request: Request) {
  ...
  return NextResponse.json({
    ...
    evolution: {
      ...
      connectivity: provider.primary === "evolution" ? connectivity : null,
    },
    meta: {
      ...
      connectivity: provider.primary === "meta" ? connectivity : null,
    },
    ...
    notes: [
      ...
      "Evolution/Baileys is fallback only when WHATSAPP_FALLBACK_EVOLUTION=true.",
      "Configure Meta webhook in Developer Console → WhatsApp → Configuration.",
      "Subscribe to messages + message status fields; verify token must match META_WHATSAPP_VERIFY_TOKEN.",
